...
echo "   npm install -g ."
echo "   npx @calypsohq/multimodal-rag-mcp-server --api-key sk-... --api-base-url https://api.calypso.so/v1"
echo ""
...
echo '{
  "mcpServers": {
    "calypso": {
      "command": "npx",
      "args": ["-y", "@calypsohq/multimodal-rag-mcp-server", "--api-key", "sk-...", "--api-base-url", "https://api.calypso.so/v1"]
    }
  }
}'
echo ""
...
echo "   - Type: command"
echo "   - Command: npx -y @calypsohq/multimodal-rag-mcp-server --api-key sk-... --api-base-url https://api.calypso.so/v1"